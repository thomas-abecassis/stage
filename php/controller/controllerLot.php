...
class ControllerLot {
    ...
    public static function searchDeepen() {
        ...
        $typesDePieces=ModelLot::getAllTypesPieces();
        $commodites=ModelLot::getAllCommodites();
        $rangements=ModelLot::getAllTypesRangements();
        $orientations=ModelLot::getAllOrientations();
        $options=ModelLot::getAllOptions();
